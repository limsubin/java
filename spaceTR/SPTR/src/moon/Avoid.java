...
public class Avoid extends JFrame implements Runnable, MouseMotionListener, MouseListener {
	...
	public void run() {
		while (true) {
			try {
				...
				if (f4 != 2 && ((xm > xr + 40 && xm < xr + 80 && ym > yr - 40 && ym < yr + 40)
						|| (xm > x1 && xm < x1 + 80 && ym > y1 && ym < y1 + 100)
						|| (xm > x2 && xm < x2 + 80 && ym > y2 - 250 && ym < y2 - 150)
						|| (xm > x3 && xm < x3 + 80 && ym > y3 - 350 && ym < y3 - 250))) {
					f4 = 1;
					repaint();
